...
INSERT INTO customers (customer_unique_id, name, phone, email, address, city, state_province, country, zip_postal_code)
VALUES ('10001', 'Pablo Picasso', '+34 636 17 63 82', NULL, 'Paseo de la Chopera, 14', 'Madrid', 'Madrid', 'Spain', '28045'),
       ...
       ('30001', 'Napoléon Bonaparte', '+33 1 79 75 40 00', NULL, '40 Rue du Colisée', 'Paris', NULL, 'France', NULL);
